...
struct Theme: Identifiable, Sendable {
    ...
    let typography: [TypographyToken: FontSpec]
    ...
    static let artisanalTech = Theme(
        ...
        typography: [
            .display:    FontSpec(size: 24, weight: .bold),
            .heading:    FontSpec(size: 20, weight: .semibold),
            .subheading: FontSpec(size: 16, weight: .medium),
            .body:       FontSpec(size: 14, weight: .regular),
            .caption:    FontSpec(size: 12, weight: .regular),
            .caption2:   FontSpec(size: 10, weight: .regular),
            .mono:       FontSpec(size: 14, weight: .regular, isMono: true),
        ],
        spacing: [
            .xxs:  5,
            .xs:   4,
