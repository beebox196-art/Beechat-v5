...
<style>
  ...
  :root {
    ...
    --bc-gap-msg: 4px;
    /* Bubble width matches native MessageBubble.BubbleWidthModifier (66% of canvas). */
    --bc-bubble-max: 66%;
 ...
 * Bridge events (bcReady, bcLink, bcImage, bcLoadEarlier, bcPinned, bcCopyMessage,
 * bcSelectionCopied) post back to Swift via webkit.messageHandlers.
 *
 * Scroll engine is ported verbatim from TranscriptSpike/.../transcript.html
 * (WP-0 G2 PASS, 100/100 assertions including 50/120 hysteresis + bounce probe).
